...
#include<string.h>
int main(){
	char e1[20],e2[20],e3[20],e4[20],e5[20];   // varible to accept names (array)
	int s1,s2,s3,s4,s5,total;					// varibles to accept salary and to make total
	float avg;
	...
	total = s1+s2+s3+s4+s5;		// total formula
	avg = total/5;				// average formula

	printf("\n Average salary of total employees is %f",avg);
	printf("\n total salary of total employees is %d",total);
